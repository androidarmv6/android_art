...
const ArmEncodingMap ArmMir2Lir::EncodingMap[kArmLast] = {
    ...
    ENCODING_MAP(kThumbLdmia,        0xe8900000, // FIXME -> Set W progammatically
                 kFmtBitBlt, 19, 16, kFmtBitBlt, 15, 0, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_BINARY_OP | REG_DEF0_USE0 | REG_DEF_LIST1 | IS_LOAD,
                 "ldmia", "!0C!!, <!1R>", 4, kFixupNone),
    ...
    ENCODING_MAP(kThumbLdrhRRI5,     0xe1c000b0, // FIXME -> imm4L is shorter than I5
                 kFmtBitBlt, 15, 12, kFmtBitBlt, 19, 16, kFmtBitBlt, 3, 0,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_DEF0_USE1 | IS_LOAD_OFF2,
    ...
    ENCODING_MAP(kThumbPop,           0xe1bd0000, // FIXME -> P must be handled
                 kFmtBitBlt, 15, 0, kFmtUnused, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_UNARY_OP | REG_DEF_SP | REG_USE_SP | REG_DEF_LIST0
                 | IS_LOAD, "pop", "<!0R>", 4, kFixupNone),
    ENCODING_MAP(kThumbPush,          0xe92d0000, // FIXME -> M must be handled
                 kFmtBitBlt, 15, 0, kFmtUnused, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1,
                 IS_UNARY_OP | REG_DEF_SP | REG_USE_SP | REG_USE_LIST0
    ...
    ENCODING_MAP(kThumbStrhRRI5,     0xe1c00000, // FIXME -> imm4L is shorter than I5
                 kFmtBitBlt, 15, 12, kFmtBitBlt, 19, 16, kFmtBitBlt, 3, 0,
                 kFmtUnused, -1, -1, IS_TERTIARY_OP | REG_USE01 | IS_STORE_OFF2,
    ...
    ENCODING_MAP(kThumbSubRI8,       0xe2500000, // FIXME -> imm12 is shorter than I8
                 kFmtBitBlt, 15, 12, kFmtBitBlt, 19, 16, kFmtUnused, 7, 0,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP | REG_DEF0_USE0 | SETS_CCODES,
    ...
    ENCODING_MAP(kThumb2MovI8M, 0xe3a00000, /* no setflags encoding */
                 ...
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0,
                 "mov", "!0C, #!1m", 4, kFixupNone),
    ENCODING_MAP(kThumb2MovImm16,       0xf2400000, // FIXME -> Oh no! ARMv6 doesn't support MOVW, literal pool must be used.
                 kFmtBitBlt, 11, 8, kFmtImm16, -1, -1, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0,
                 "mov", "!0C, #!1M", 4, kFixupNone),
    ...
    ENCODING_MAP(kThumb2Stmia,         0xe8800000,
                 ...
                 IS_BINARY_OP | REG_DEF0_USE0 | REG_USE_LIST1 | IS_STORE,
                 "stmia", "!0C!!, <!1R>", 4, kFixupNone),
    ENCODING_MAP(kThumb2AddRRR,  0xe0800000, /* setflags encoding */
                 kFmtBitBlt, 15, 12, kFmtBitBlt, 19, 16, kFmtBitBlt, 3, 0,
                 kFmtShift, -1, -1,
                 IS_QUAD_OP | REG_DEF0_USE12 | SETS_CCODES,
                 "adds", "!0C, !1C, !2C!3H", 4, kFixupNone),

/* The following opcodes still must be converted */
